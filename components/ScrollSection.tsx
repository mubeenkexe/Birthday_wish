      ...
      <div ref={triggerRef}>
        <div ref={sectionRef} className="scroll-section-inner">
          <div className="scroll-section flex items-center flex-col">
            <h3 className="text-center px-4 md:px-0">
          ...
          <div className="scroll-section flex flex-col gap-3 justify-center items-center">
            <h4 className="yourLove text-3xl md:text-5xl lg:text-6xl">MOTI 🐱✨</h4>
          </div>
          <div className="scroll-section flex items-center flex-col">
            <h3 className="text-xl font-bold text-white text-center px-4 md:px-0">
